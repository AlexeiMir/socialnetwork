            ...
            <Col span={8} offset={8} className={style.formGroup}>
                ...
                <form onSubmit={handleSubmit}>
                    <div>
                        ...
                        <i className={style.mtrlSelect}></i>
                        <Row><Col
                            span={8}>{createField(null, "rememberMe", [], InputComponent, {type: "checkbox"}, "remember me")}</Col></Row>


                        {captchaUrl && <img src={captchaUrl}/>}
                        {captchaUrl && createField("Symbols from image", "captcha", [required], InputComponent, {})}

                        <Row><Col span={16} offset={8}><Button type="primary"
                                                               htmlType="submit">Login</Button></Col></Row>
