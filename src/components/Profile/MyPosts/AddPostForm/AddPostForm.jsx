...
const AddPostFormPage = (props) => {
    ...
    return (
        ...
        <Field className={s.post} placeholder='Add new post' component={TextareaComponent} name='newPostText' validate={[required, maxLength10]} placeholder="Post your comment" />
