                ...
                <div>
                    {u.followed ?
                        <button onClick={() => { 
                            ...
                            `,{withCredentials:true, headers: {'API-KEY':'9aa0b454-6ceb-4bde-96c6-c40c83a0a7db'}}).then(response =>{
                        ...
                        <button onClick={() => {
                            axios.put(`https://social-network.samuraijs.com/api/1.0/follow/${u.id}
                            `,{},{withCredentials:true, headers: {'API-KEY':'9aa0b454-6ceb-4bde-96c6-c40c83a0a7db'}}).then(response =>{
                                if (response.data.resultCode == 0) {
                props.follow(u.id)
            }
